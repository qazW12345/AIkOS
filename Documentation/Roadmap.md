...
**Current phase: Phase 4 — A Face** (not started; v0.6.0 target)
...
| 3 | Memory & Files | Allocators, filesystem, ELF loader, first userland apps | Boots from disk image; runs /bin apps | ✅ **DONE — v0.5.0 (2026-08-06)** — 36/36 green; AIkFS + ELF /bin apps |
